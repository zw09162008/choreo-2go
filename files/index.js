...
const UUID = process.env.UUID || '222e0d08-b275-4dd3-9e75-f3094b36fa2a'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.darkblue.free.hr';     
const NEZHA_PORT = process.env.NEZHA_PORT || '2096';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '6nH1oOcS2azUBVI3x9';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.darkblue.free.hr';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
